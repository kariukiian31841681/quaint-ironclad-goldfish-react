        ...
        <div className="footer4-content">
          ...
          <div className="footer4-links">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="footer4-text16">Portfolio</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="footer4-text15">Contact</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link4 ?? (
                <Fragment>
                  <span className="footer4-text19">About Me</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link5 ?? (
                <Fragment>
                  <span className="footer4-text14">Blog</span>
                </Fragment>
              )}
            </a>
          </div>
