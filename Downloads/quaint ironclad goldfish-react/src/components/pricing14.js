              ...
              {props.content2 ?? (
                <Fragment>
                  <span className="pricing14-text202">
                    <span>
                      Our prices are favorable and worth the services offered.
                      <span
              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <h3 className="pricing14-text108 thq-heading-3">
                    {props.plan1Price ?? (
                      <Fragment>
                        <span className="pricing14-text206">Ksh 10,000</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text199">Ksh 100,000</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  ...
                  <h3 className="pricing14-text115 thq-heading-3">
                    {props.plan2Price ?? (
                      <Fragment>
                        <span className="pricing14-text188">Ksh 20,000</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text168">Ksh 200,000</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  ...
                  <h3 className="pricing14-text123 thq-heading-3">
                    {props.plan3Price ?? (
                      <Fragment>
                        <span className="pricing14-text155">Ksh 30,000</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text194">Ksh 300,000</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <div className="pricing14-price16">
                <div className="pricing14-price17">
                  ...
                  <h3 className="pricing14-text132 thq-heading-3">
                    {props.plan1Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text173">Ksh 20,000/yr</span>
                      </Fragment>
                    )}
                  </h3>
              ...
              <div className="pricing14-price18">
                <div className="pricing14-price19">
                  ...
                  <h3 className="pricing14-text139 thq-heading-3">
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text193">Ksh 300,000/yr</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
