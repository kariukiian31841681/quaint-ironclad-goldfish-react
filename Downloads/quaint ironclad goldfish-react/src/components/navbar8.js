        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar8-text18">Web Development</span>
                </Fragment>
              )}
            </a>
            <a href={props.link2Url} className="thq-link thq-body-small">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text16">App Development</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text24">Graphic Design</span>
                </Fragment>
              )}
            </a>
            <div
            ...
            >
              <span className="thq-link thq-body-small">
                {props.link4 ?? (
                  <Fragment>
                    <span className="navbar8-text21">Contact Me</span>
                  </Fragment>
                )}
              </span>
                            ...
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="navbar8-text22">
                                  Explore my web development projects and
                                  skills.
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text23">
                                  Discover my app development projects and
                                  expertise.
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text26">
                                  View my graphic design portfolio and
                                  capabilities.
                                </span>
                              </Fragment>
                            )}
                ...
                <div className="navbar8-menu-item7">
                  ...
                  <div className="navbar8-content7">
                    <span className="navbar8-page32 thq-body-large">
                      {props.page3 ?? (
                        <Fragment>
                          <span className="navbar8-text25">Graphic Design</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                ...
                <div className="navbar8-menu-item8">
                  ...
                  <div className="navbar8-content8">
                    <span className="navbar8-page42 thq-body-large">
                      {props.page4 ?? (
                        <Fragment>
                          <span className="navbar8-text19">Contact Me</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
...
Navbar8.defaultProps = {
  ...
  action1: undefined,
  page2ImageAlt: 'App Development Image',
  link2: undefined,
  logoAlt: 'Ian Kariuki Portfolio',
  logoSrc:
    'https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/84ec08e8-34e9-42c7-9445-d2806d156403/fac575ac-7a41-484f-b7ac-875042de11f8?org_if_sml=1&force_format=original',
  page3ImageAlt: 'Graphic Design Image',
  page1: undefined,
  link1: undefined,
  page4ImageSrc:
  ...
  page2: undefined,
  link4: undefined,
  page4ImageAlt: 'Contact Me Image',
  ...
  page1ImageAlt: 'Web Development Image',
  action2: undefined,
